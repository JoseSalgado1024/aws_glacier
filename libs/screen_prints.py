...
SCREEN_PRINTS = [
    # AWS
    {'INVALID_CREDENTIALS': ['Las credenciales de AWS provistas no '
                             'son validas.',
    ...
    {'FILE_READY_FOR_DOWNLOAD': ['El archivo \"{f}\" esta disponible y listo '
                                 ...
                                 'download it.']},
    {'FILE_EXISTS_BUT_NOT_AVAILABLE': ['El archivo \"{f}\" exite, pero no esta'
                                       ' disponible.',
    ...
    {'FILE_EXISTS_BUT_NOT_AVAILABLE_GLACIER': ['El archivo \"{f}\" exite, pero'
                                               ...
                                               '\'t download it,  because '
                                               'it\'s stored under \"GLACIER\"'
                                               ' class.']},
    ...
    {'CONF_FILE_LOAD_FAIL': ['No se pudo cargar el archivo de '
                             'configuración: \"{f}\".',
    ...
    # Common Errors
    {'FATAL_ERROR_ABORTING': ['ERROR FATAL!, se abortará y terminará el '
                              'proceso!',
...
try:
    mensages = Messages(SCREEN_PRINTS, LANGUAGES, 'ES')
